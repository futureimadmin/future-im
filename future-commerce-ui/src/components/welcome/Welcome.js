        ...
        <div className="welcome-container">
            <div className="welcome-grid">
                ...
                <div className="from-desk">
                    <h2 className="section-title">From the Desk of Anantha</h2>
                    <img src={ananthaImage} alt="Anantha" className="ceo-image" />
                    <p className="ceo-message">
                        "At Future IM, we're not just building an e-commerce platform; we're creating the future of shopping. 
                        Our voice-enabled commerce solution represents our commitment to innovation and accessibility. 
                        Together, we're making technology work for everyone."
                    </p>
                    <div className="news-title">Anantha</div>
